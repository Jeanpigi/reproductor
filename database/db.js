...
const checkDatabaseConnection = async () => {
  try {
    ...
    connection.release(); // Importante liberar la conexión después de la prueba exitosa.
  } catch (error) {
    console.error("Error al conectar a la base de datos:", error);
    // Puedes manejar el error de alguna manera apropiada, por ejemplo, cerrar la aplicación.
    process.exit(1);
  }
};
